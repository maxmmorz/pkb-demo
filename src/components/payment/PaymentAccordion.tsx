      ...
      case "kasi":
        return (
          <button
            ...
            className="w-full rounded-xl bg-[#F14635] py-2.5 font-semibold text-white transition-all hover:bg-[#D93D2E] active:scale-[0.98]"
          >
      ...
      case "apple":
        return (
          <button
            ...
            className="flex w-full items-center justify-center gap-2 rounded-xl bg-black py-2.5 font-semibold text-white transition-all hover:bg-gray-900 active:scale-[0.98]"
          >
        ...
        return (
          <div className="space-y-3">
            ...
            <button
              ...
              className="mt-4 w-full rounded-xl bg-gray-900 py-2.5 font-semibold text-white transition-all hover:bg-gray-800 active:scale-[0.98] disabled:cursor-not-allowed disabled:opacity-50"
            >
              Оплатить картой
            </button>
          </div>
        ...
        return (
          <div className="space-y-3">
            ...
            <button
              ...
              className="w-full rounded-xl bg-gray-900 py-2.5 font-semibold text-white transition-all hover:bg-gray-800 active:scale-[0.98] disabled:cursor-not-allowed disabled:opacity-50"
            >
              Оплатить с баланса
            </button>
          </div>
